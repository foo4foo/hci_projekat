...
Insert into hci.softwares (softwareId, name, operatingSys, developer, site, year, price, description, deleted) values
("VS17","Visual Studio 2017", "Windows 10", "Microsoft", "www.microsoft.com", 2017, 150.50, "IDE", 0);